...
namespace Jarvis
{
    internal class GestureRecognition
    {
        ...
        private Point myPoint, prevPoint = new Point(0, 0);
        private MainScreen mscreen;
        static public Queue m_poin_que = new Queue(50);
        ...
        private static int count = -1, x_displacement, y_displacement, XD, YD;
        private Point mousePoint;
        private float sensitivity = 9.5f;
        ...
        private void newMouseInvoke()
        {
            ...
            if (sensitivity != 0)
            {
                if (x_displacement > y_displacement)
                    sensitivity = x_displacement * 0.2f;
                else
                    sensitivity = y_displacement * 0.2f;
            }
            */
